...
uri = 'mysql://root:Celular135#@localhost:3306/mlflow'
## TAGs do MLFlow
_MODEL_NAME_ = 'MobileNet sem dense 1024'
...
def ModeloKeras_MobileNet(BATCH = 10, EPOCHs= 10):

    from tensorflow.keras.applications.mobilenet_v2 import MobileNetV2
    _MODEL_FILE_ = 'mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_128_no_top.h5'
...
def Callbacks():
    ...
    return [cp_callback, Callback_acc] #val_loss_callback, Callback_acc]
...
def main():
    ...
    with mlflow.start_run(run_name=_MODEL_NAME_):
        ...
        #Criação do modelo
        model, history, summary = ModeloKeras_MobileNet(BATCH = 20, EPOCHs = 100)
